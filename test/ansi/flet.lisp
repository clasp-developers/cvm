...
(5am:test flet.14
  (signals-eval program-error (flet ((%f (a) a)) (%f))))

;;; Too many arguments (section 3.5.1.3)
(5am:test flet.15
  (signals-eval program-error (flet ((%f (a) a)) (%f 1 2))))

;;; Invalid keyword argument (section 3.5.1.5)
(5am:test flet.16
  (signals-eval program-error (flet ((%f (&key a) a)) (%f '(foo)))))
...
#+(or) ; figure out lambda-parameters-limit
(deftest flet.20
