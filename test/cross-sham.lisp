...
(defclass cross-client (cvm.cross:client) ())

(defmethod clostrum-sys:variable-cell :around ((client cross-client)
                                               environment symbol)
...
(defmethod clostrum-sys:variable-status :around ((client cross-client)
                                                 environment symbol)
  (if (keywordp symbol)
      :constant
      (call-next-method)))
